...
import { ArrowRight, BadgeCheck, Plus, Sparkles } from "lucide-react";
import chhood from "../../assets/carhartt/chhood.png";
import s from "../../assets/s.png";
import nb from "../../assets/nb.png";

const featuredProducts = [
  { id: 101, title: "Utility Trouser", brand: "Carhartt", price: 135, img: chhood, category: "Men", subCategory: "Pants", tag: "Workwear" },
  { id: 102, title: "City Sling Bag", brand: "JThrift", price: 55, img: s, category: "Women", subCategory: "Accessories", tag: "Daily carry" },
  { id: 103, title: "Classic Basic Tee", brand: "New Balance", price: 35, img: nb, category: "Men", subCategory: "T-Shirts", tag: "Easy layer" },
];
...
const Ecommerce = ({ addToCart, filters, openShop }) => {
  ...
  return (
    <section className="bg-[#f6f6f3] px-4 py-16 md:px-10 md:py-24">
      <AnimatePresence>
        {addedMessage && (
          <motion.div
      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="mb-10 grid gap-6 border-b border-black/10 pb-8 md:grid-cols-[1fr_auto] md:items-end">
          ...
          <button
            ...
            className="inline-flex h-12 items-center justify-center gap-2 border border-black bg-white px-5 text-[11px] font-black uppercase tracking-[0.2em] transition hover:bg-black hover:text-white"
          >
        ...
        <div className="mt-16 grid grid-cols-1 border border-black/10 bg-white md:grid-cols-3">
          {collections.map((collection) => (
            <button
              key={collection.title}
              type="button"
              onClick={() => openShop("All", collection.category, collection.subCategory)}
              className="group border-b border-black/10 p-6 text-left transition hover:bg-black hover:text-white md:border-b-0 md:border-r last:border-r-0"
            >
